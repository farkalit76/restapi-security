...
import com.farkalit.test.config.JwtTokenUtil;
import com.farkalit.test.model.JwtRequest;
import com.farkalit.test.model.JwtResponse;
...
public class JwtAuthenticationController {
	...
	public ResponseEntity<?> getUserinfo(@RequestBody UserDto user) throws Exception {
		LOG.info("getUserinfo from user:{}", user);
